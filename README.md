...
- [Morse-code-using-Ruby](#morse-code-using-ruby)
...
# 📖 [Morse-code-using-Ruby] <a name="about-project"></a>

**Morse-code-using-Ruby** is a simple ruby project that was created to decode the morse code to understandable English.
...
Feel free to check the [issues page](https://github.com/kennedyowusu/morse-code/issues).
...
This project is [MIT](https://github.com/kennedyowusu/morse-code/blob/develop/MIT.md) licensed.
